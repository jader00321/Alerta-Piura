...
/**
 * GraficoReportesDia - Componente de gráfico de barras para mostrar actividad de reportes por día
 * @param {Object} props - Propiedades del componente
 * @param {Array} props.chartData - Datos para el gráfico en formato [{ date: string, count: number }]
