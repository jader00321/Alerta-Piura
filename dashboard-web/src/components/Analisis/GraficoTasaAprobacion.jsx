...
/**
 * Componente que muestra un gráfico de pastel (tasa de aprobación) con porcentajes de aprobados y rechazados.
 * 
 * Utiliza Recharts y Material UI para renderizar visualmente la proporción de reportes aprobados frente a los rechazados.
 *
 * @component
 * @example
 * // Ejemplo de uso:
 ...
 *   statusData={[
 *     { name: 'Verificado', value: 80 },
 *     { name: 'Rechazado', value: 20 }
 *   ]}
 *   loading={false}
 * />
 *
 * @param {Object[]} statusData - Datos de estado con nombres y valores. Debe contener objetos con `name` ("Verificado" o "Rechazado") y `value` (número de casos).
 * @param {string} statusData[].name - Nombre de la categoría ("Verificado" o "Rechazado").
 * @param {number} statusData[].value - Cantidad de casos en esa categoría.
 * @param {boolean} loading - Indica si el gráfico está cargando (muestra un esqueleto mientras tanto).
 *
 * @returns {JSX.Element} Un componente con un gráfico de pastel que representa los porcentajes de aprobación y rechazo.
 */
