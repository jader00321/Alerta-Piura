      ...
      child: InkWell(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding:
                  EdgeInsets.fromLTRB(12.0, hasPhoto ? 12.0 : 16.0, 12.0, 12.0),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  // --- NUEVO: Fila 1 - Chips de Estado/Prioridad ---
                  if (isPriority || hasPendingSupport) ...[
                    // Solo mostrar la fila si hay al menos un chip
                    Row(
                      children: [
                    ...
                    const SizedBox(
                        height:
                            8), // Espacio después de la primera fila de chips
                  ],
                  // --- FIN NUEVO ---
