...
class TarjetaModeracionReporte extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bool esComentario = reporteModeracion.tipo == TipoReporteModeracion.comentario;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Row(
                    children: [
                      Icon(
                        esComentario ? Icons.chat_bubble_outline : Icons.person_outline,
                        size: 18,
                        color: theme.colorScheme.primary,
                      ),
                      const SizedBox(width: 8),
                      Text(
                        esComentario ? 'Reporte de Comentario' : 'Reporte de Usuario',
                  ...
                  Chip(
                    ...
                    label: Text(reporteModeracion.estado, style: TextStyle(fontSize: 10, color: statusColor)),
              ...
              Text(
                esComentario ? '"${reporteModeracion.contenido}"' : reporteModeracion.contenido,
                style: theme.textTheme.bodyMedium?.copyWith(fontStyle: esComentario ? FontStyle.italic : FontStyle.normal),
                maxLines: 2,
                  ...
                  if (estaPendiente && onQuitar != null)
                    SizedBox(
                      ...
                      child: TextButton.icon(
                        ...
                        onPressed: isDeleting ? null : () => onQuitar!(reporteModeracion.id, reporteModeracion.tipo),
                      ),
                    ),
                ],
              ),
